...
export default function Navbar({ loggedIn = false }: NavbarProps) {
  ...
  return (
    <>
      <nav className="font-mono sticky top-0 z-50 w-full border-b border-[#F0EFF4] bg-[#F0EFF4]/95 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-8">
            <a href="/" className="italic text-xl font-semibold tracking-tight text-[#1C1819]">
              Increderion
            </a>
