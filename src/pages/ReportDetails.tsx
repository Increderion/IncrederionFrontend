                    ...
                    <div key={finding.id} className="flex gap-4 rounded-2xl border border-[#E5E3EC] dark:border-[#2E2A38] bg-white/50 dark:bg-[#1C1A22]/50 p-4 backdrop-blur-sm">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center justify-between gap-2">
                          <span className="font-mono text-[10px] font-bold uppercase tracking-tighter text-[#9C99A6]">
                            {finding.source || finding.category}
                          </span>
                          <SeverityBadge severity={finding.severity} />
                        </div>
                        <h4 className="font-mono text-sm font-bold text-[#1C1819] dark:text-[#F0EFF4]">
                          {finding.title}
                        </h4>
                        <p className="font-mono text-xs leading-relaxed text-[#5C5867] dark:text-[#9C99A6] line-clamp-3">
                          {finding.summary}
                        </p>
                        {finding.url && (
                          <a href={finding.url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 font-mono text-[10px] font-bold text-[#92140C] hover:underline">
                            ZOBACZ ŹRÓDŁO <span aria-hidden>↗</span>
                          </a>
                        )}
                      </div>
                    </div>
